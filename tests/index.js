...
describe('Authorization', () => {
    ...
    describe('POST', () => {
        ...
        it('Requesting without key should fail');
        it('Requesting with non-existing key should fail');
        it('Requesting with valid key should return info');
        it('Re-checking should include decreased usage');
    });
});